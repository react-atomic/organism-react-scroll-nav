...
/* harmony import */ var _scrollDispatcher__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../scrollDispatcher */ "./build/es/src/scrollDispatcher.js");
...
var scrollStore = /*#__PURE__*/function (_ReduceStore) {
  Object(reshow_runtime_es_helpers_inheritsLoose__WEBPACK_IMPORTED_MODULE_1__["default"])(scrollStore, _ReduceStore);
  ...
  function scrollStore() {
    ...
    Object(reshow_runtime_es_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__["default"])(Object(reshow_runtime_es_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_0__["default"])(_this), "storeName", 'delayScroll');

    Object(reshow_runtime_es_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__["default"])(Object(reshow_runtime_es_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_0__["default"])(_this), "isInitEvent", {});

    Object(reshow_runtime_es_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__["default"])(Object(reshow_runtime_es_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_0__["default"])(_this), "isInitResizeEvent", false);

    Object(reshow_runtime_es_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__["default"])(Object(reshow_runtime_es_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_0__["default"])(_this), "spys", {});
  ...
  _proto.getInitialState = function getInitialState() {
    ...
    this.arrNode = Object(immutable__WEBPACK_IMPORTED_MODULE_3__["Map"])();
    this.margins = Object(immutable__WEBPACK_IMPORTED_MODULE_3__["Set"])();
    this.scrollMonitor = this.runScrollMonitor.bind(this);
    this.bindHandleResize = this.handleResize.bind(this);
    return Object(immutable__WEBPACK_IMPORTED_MODULE_3__["Map"])({
      scrollDelay: 50,
      scrollMargin: 0
    });
  };
  ...
  _proto.triggerScroll = function triggerScroll(scrollNode) {
    ...
    (this.spys[scrollId] || []).forEach(function (node) {
      ...
      var _get = Object(get_object_value__WEBPACK_IMPORTED_MODULE_8__["default"])(node, ['props'], {}),
  ...
  _proto.getAttachToId = function getAttachToId(node) {
    var attachTo = Object(get_object_value__WEBPACK_IMPORTED_MODULE_8__["default"])(node, ['props', 'attachTo']);
    var attachToId;
  ...
  _proto.attach = function attach(node) {
    ...
    if (!this.spys[attachToId]) {
      this.spys[attachToId] = Object(immutable__WEBPACK_IMPORTED_MODULE_3__["Set"])().add(node);
    } else {
...
/* harmony default export */ __webpack_exports__["default"] = (new scrollStore(_scrollDispatcher__WEBPACK_IMPORTED_MODULE_9__["default"]));


/***/ })

})
//# sourceMappingURL=main.203397ac289777b93c1e.hot-update.js.map